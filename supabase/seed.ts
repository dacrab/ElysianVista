...
async function seedTenants(supabase: SupabaseClient): Promise<Tenant[]> {
  ...
  const { data, error } = await supabase
    ...
    .insert([
      {
        name: 'aBroker Real Estate',
        slug: 'abroker',
        logo_url: 'https://i.imgur.com/5nL1sA6.png',
        primary_color: '#0052CC',
        contact_email: 'contact@abroker.com',
        website_url: 'https://abroker.com',
        tagline: 'Your Trusted Real Estate Partner',
        bio: 'aBroker has been a leading real estate agency for over 20 years, specializing in urban and suburban properties.',
      },
      {
        name: 'Real Status Properties',
        slug: 'realstatus',
        logo_url: 'https://i.imgur.com/6fN0g9s.png',
        primary_color: '#D93F4C',
        contact_email: 'info@realstatus.com',
        website_url: 'https://realstatus.com',
        tagline: 'Luxury Properties for the Discerning Client',
        bio: 'Real Status offers an exclusive portfolio of luxury villas, penthouses, and beachfront homes.',
      },
    ])
    .select('id, name, slug');
  if (error) {
...
async function seedUsersAndProfiles(
  ...
  const usersToCreate = [
    {
      email: 'admin@abroker.com',
      password: 'password123',
      full_name: 'Adam Broker',
      username: 'adamb',
      role: 'admin',
      tenant_slug: 'abroker',
    },
    {
      email: 'manager@abroker.com',
      password: 'password123',
    ...
    {
      email: 'realtor@abroker.com',
      password: 'password123',
      full_name: 'Rick Realtor',
      username: 'rickr',
      role: 'realtor',
      tenant_slug: 'abroker',
    },
    {
      email: 'admin@realstatus.com',
      password: 'password123',
      full_name: 'Stacy Status',
      username: 'stacys',
      role: 'admin',
      tenant_slug: 'realstatus',
    },
    {
      email: 'manager@realstatus.com',
      password: 'password123',
    ...
    {
      email: 'realtor1@realstatus.com',
      password: 'password123',
      full_name: 'Rachel Realtor',
      username: 'rachelr',
      role: 'realtor',
      tenant_slug: 'realstatus',
    },
...
async function seedListings(supabase: SupabaseClient, tenants: Tenant[], users: UserSeedData[]) {
  ...
  const listings = [
    {
      tenant_id: abrokerTenantId,
      agent_id: abrokerAgent.id,
      title: 'Downtown Modern Loft',
      description: 'A sleek 2-bedroom loft in the vibrant heart of the city.',
      address: '123 Main St',
      city: 'Metropolis',
      country: 'USA',
      price: 650000.0,
      ...
      bathrooms: 2,
      area_sqft: 1200,
      image_urls: ['https://i.imgur.com/gJ4dYfG.jpeg'],
      status: 'available',
    },
    {
      tenant_id: realstatusTenantId,
      agent_id: realstatusAgent.id,
      title: 'Luxury Beachfront Villa',
      description: 'Exclusive villa with private beach access and stunning ocean views.',
      ...
      bathrooms: 6,
      area_sqft: 5000,
      image_urls: ['https://i.imgur.com/kJ4dYfG.jpeg'],
      status: 'available',
    },
  ];
